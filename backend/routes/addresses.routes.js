...
router.get("/adrese", listAddresses);
router.post("/adrese", createAddress);
router.patch("/adrese/:id/default", setDefault);
router.put("/adrese/:id", updateAddress);
router.delete("/adrese/:id", deleteAddress);
